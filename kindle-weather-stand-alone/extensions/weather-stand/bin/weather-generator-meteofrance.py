...
# Get weather data from the Open-Meteo Meteo-France model API (no key required).
# Meteo-France's AROME/ARPEGE models are capped at 4 forecast days (today + 3).
api_url = (
